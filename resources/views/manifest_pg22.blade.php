...
<div class="container fluid">
    <h5 class="text-center">SALES XINVOICE / SHIPPING MANIFEST</h5>
    <h5 class="text-center">SALES DEAILS ATTACHMENT PAGE</h5>
    {{-- line 1 --}}


    <table style="table-layout: auto" class="table_sm table-bordered">
        <tr>
            <td style="vertical-align:top;"> @include('page2.top_left_table')</td>
            <td style="vertical-align:top;"> @include('page2.top_right_table')</td>
        </tr>
    </table>
    ...
    <table style="table-layout: auto; width:100%" class="table table-bordered">
        ...
        <tr>
            <td class="text-left">I confirm that the contents of this shipment match in weight and count as indicated
                above.<br>
                I agree to take custody of all items as inicated received above - and which are not circled. <br>
                The products circled abbove are rejected for delivery and remain in the custody of the distributor for
                return to the shipper as indicated in this form and all attached product detail sheet(s).
        </tr>
    </table>
    <table style="table-layout: auto; width:100%" class="table table-bordered">
        <tr>
